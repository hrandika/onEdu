...
class LoginActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        tokenText = findViewById<TextView>(R.id.decryptedToken)

        useBio.setOnClickListener {
            this.displayBiometricPromptDecrypt(LoggedInUserView(username.text.toString(), password.text.toString()));
        }
    ...
    private fun displayBiometricPromptDecrypt(model: LoggedInUserView) {
