...
class LoginActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        useBio.setOnClickListener {
            this.showBiometricDecryptedData(LoggedInUserView(username.text.toString(), password.text.toString()));
        }
    ...
    private fun showBiometricDecryptedData(model: LoggedInUserView) {
